...
namespace HN.Management.Engine.Repositories.Generic
{
    public abstract class CosmosRepository<T> : IRepository<T>, IContainerContext<T> where T : BaseEntity
    {
        ...
        ///     Cosmos DB factory
        /// </summary>
        private readonly ICosmosContainerFactory _cosmosDbContainerFactory;
        ...
        {
            this._cosmosDbContainerFactory = cosmosDbContainerFactory ?? throw new ArgumentNullException(nameof(ICosmosContainerFactory));
        ...
        {
            CosmosSpecificationEvaluator<T> evaluator = new CosmosSpecificationEvaluator<T>();
