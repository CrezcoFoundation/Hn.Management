...
namespace HN.Management.Web.Apis.V1.Controllers
{
    ...
    public class UserRoleController : Controller
    {
        ...
        private readonly IUserRoleService _userPermitService;
        public UserRoleController(IDistributedCache distributedCache, IUserRoleService userPermitService)
        {
        ...
        [HttpPost]
        [Route("new")]
        public async Task<IActionResult> AddAsync(UserRoleDTO userProjectPermit)
        {
        ...
        [HttpPut]
        [Route("update")]
        public async Task<IActionResult> UpdateAsync(UserRoleDTO userProjectPermit)
        {
        ...
        [HttpDelete]
        [Route("delete")]
        public async Task<IActionResult> DeleteAsync(UserRoleDTO userProjectPermit)
        {
        ...
        public async Task<IActionResult> GetAllActivitiessUsingRedisCache()
        {
            ...
            var activities = new List<UserRoleDTO>();
            ...
            if (redisActivitiesList != null)
            {
                ...
                activities = JsonConvert.DeserializeObject<List<UserRoleDTO>>(serializedActivitiesList);
            }
            else
            {
